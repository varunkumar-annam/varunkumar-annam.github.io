...
class ImageToPDFConverter:
    ...
    def initialize_ui(self):
        ...
        convert_button=tk.Button(self.root,text="Convert of PDF",command=self.convert_images_to_pdf)
    ...
    def convert_images_to_pdf(self) :
        ...
        for image_path in self.image_paths:
            ...
            available_width=540
            available_heigh=720
            scale_factor=min(available_width/img.width , available_heigh/img.height)
